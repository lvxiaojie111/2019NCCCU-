...
class TrainModel(object):
    ...
    def model(self):
        ...
        print(">>> input conv2: {}".format(conv2))
        ...
        print(">>> input conv3: {}".format(conv3))
        conv3 = tf.nn.max_pool(conv3, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')
        print(">>> input conv3: {}".format(conv3))
        conv3 = tf.nn.dropout(conv3, self.keep_prob)
        print(">>> convolution 3: ", conv3.shape)
        next_shape = conv3.shape[1] * conv3.shape[2] * conv3.shape[3]
        print(">>> input next_shape: {}".format(next_shape))
        # 全连接层1
        ...
        print(">>> input dense: {}".format(dense))
        ...
        print(">>> input y_predict: {}".format(y_predict))
        return y_predict
    ...
    def train_cnn(self):
        ...
        max_idx_l = tf.argmax(tf.reshape(self.Y, [-1, self.max_captcha, self.char_set_len]), 1)  # 标签
        # 计算准确率
        ...
        with tf.Session() as sess:
            ...
            for i in range(10000):
                ...
                if step % 10 == 0:
                    ...
                    loss_summary = tf.summary.scalar('loss_summary', cost_)
                    ...
                    # 每训练500轮就保存一次
                    train_acc = tf.summary.scalar('train_acc', acc_image)
                    ...
                    val_acc = tf.summary.scalar('val_acc', acc_image)
